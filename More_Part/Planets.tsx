...
export default function Planets(){
  console.log('Loading texture from:', require('../assets/images/mapu.jpg'));
  const world = useLoader(TextureLoader, require('../assets/images/Mercury.png'))
  ...
  return (
    ...
    <Text style={styles.textbold}>Distance from Earth</Text>
    <Text style={styles.text}>77 million km</Text>
