...
export default function Planets(){
  ...
  const world = useLoader(TextureLoader, require('../assets/images/Mars.jpg'))
  ...
  return (
    ...
    <Text style={styles.text}>227.9 million km</Text>
    ...
    <Text style={styles.text}>Carbon dioxide{"\n"}Nitrogen{"\n"}Argon{"\n"}Oxygen</Text>
    <Text style={styles.textbold}>Other Names</Text>
    <Text style={styles.text}>Red Planets{"\n"}Ares{"\n"}Nergal{"\n"}Mangala</Text>
    </ScrollView>
    </View>
  </View>
  );
