...
export default function Planets(){
  ...
  const world = useLoader(TextureLoader, require('../assets/images/mapu.jpg'))
  ...
  return (
    ...
    <Text style={styles.text}>149.6 million km</Text>
    ...
    <Text style={styles.text}>Nitrogen{"\n"}Oxygen{"\n"}Argon{"\n"}Carbon dioxide{"\n"}Neon{"\n"}Helium{"\n"}Methan{"\n"}Krypton{"\n"}Hydrogen</Text>
    <Text style={styles.textbold}>Other Names</Text>
    <Text style={styles.text}>Blue Planet{"\n"}Terra{"\n"}Gaia</Text>
    </ScrollView>
    </View>
  </View>
  );
